...
def transferability(attack,data,size,batch_size=128):
    ...
    models=[]
    for i in range(1,FLAGS.n+1):
        models.append(load_model(os.path.join(cwd,"experiments",FLAGS.data,FLAGS.data+"_models_"+''.join(str(FLAGS.lamda).split('.'))+'_'+str(FLAGS.n)+str('_')+str(FLAGS.models_batch)),i))
